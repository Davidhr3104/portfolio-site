      ...
      <div className="relative mx-auto max-w-5xl px-6 pt-44 pb-32 sm:pt-56 sm:pb-40 lg:pb-48">
        ...
        <Reveal delay={240}>
          <p className="mt-10 max-w-xl font-sans text-lg sm:text-xl leading-relaxed text-foreground/80">
            {t.hero.pitch} <span className="text-muted">{t.hero.audience}</span>
          </p>
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <button
              ...
              className={`glossy-pill px-4 py-2 text-sm ${intent === "hiring" ? "glossy-pill--active" : ""}`}
            >
              {t.hero.pillHiring}
            </button>
            <button
              ...
              className={`glossy-pill px-4 py-2 text-sm ${intent === "partnership" ? "glossy-pill--active" : ""}`}
            >
